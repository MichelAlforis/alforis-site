    ...
    <section className={`relative w-full overflow-hidden ${extraClass}`}>      
      <div className="flex flex-col items-center text-center px-4 py-20 md:py-32">
        <motion.h1
          ...
          className="text-anthracite font-bold uppercase dark:text-acier leading-snug mb-6 md:pt-28 "
        >
        ...
        <motion.p
          ...
          className="text-md md:text-xl font-normal text-acier dark:text-acier font-light mb-8 max-w-2xl mx-auto leading-relaxed"
        >
