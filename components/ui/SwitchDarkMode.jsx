...
export default function SwitchDarkMode() {
  ...
  return (
    ...
    >
      ...
      <Moon className={`w-5 h-5 text-doré transition-opacity duration-300 ${isLight ? 'opacity-100' : 'opacity-0'}`} />
      <Sun  className={`w-5 h-5 text-doré transition-opacity duration-300 ${isLight ? 'opacity-0' : 'opacity-100'}`} />
