...
const customKeys = ["doré", "acier", "ardoise", "ivoire", "anthracite", "vertSauge"];
...
const jsOutputPath = path.resolve(__dirname, '../styles/generated-colors.mjs'); // <= OK
...
const cssOutputPath = path.resolve(__dirname, '../styles/generated-colors.css'); // <= OK
