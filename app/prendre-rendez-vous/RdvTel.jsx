...
export default function MyApp() {
  ...
  async function handleBookingSuccessful(eventDetail) {
    ...
    // console.log("handleBookingSuccessful called with eventDetail:", eventDetail); // Original log, can be kept or removed
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Potentially redirect or show a success message to the user here
      } else {
      ...
      cal("on", {
        ...
        callback: (e) => {
          ...
          if (e.detail && e.detail.data) {
            ...
            console.error("bookingSuccessfulV2 event did not contain e.detail.data", e);
          }
        }
      });
