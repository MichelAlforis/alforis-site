...
export const FooterConfig = {
  ...
  logo: '/assets/icons/Logo.png', // Ajout du chemin vers le logo
  ...
  tabsReseaux: [
    ...
    {
      label: "Instagram",
      href: "https://www.instagram.com/alforis_finance/",
      ariaLabel: "Suivez Alforis sur Instagram",
      viewBox: "0 0 16 16",
    ...
    {
      label: "X (Twitter)",
      href: "https://twitter.com/alforis_finance",
      ariaLabel: "Suivez Alforis sur X",
      viewBox: "0 0 16 16",
...
{ 
  ...
  legalInfo: {
    ...
    companyInfo: {
      ...
      cnil: "Déclaration CNIL : 1234567"
    }
  },

  // Partenaires (si vous voulez ajouter une section partenaires)
  partners: [
    {
  ...
  messages: {
    newsletter: {
      ...
      description: "Inscrivez-vous à notre newsletter pour recevoir nos actualités et conseils patrimoniaux.",
