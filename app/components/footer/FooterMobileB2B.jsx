...
import { openCookieSettings } from '@/lib/cookieConsent' // ✅ helper centralisé
      ...
      <div className="grid grid-cols-[20%_80%] gap-2 mt-4">
        ...
        <div className="flex flex-col gap-1 text-vertSauge text-sm font-sans items-end justify-center">
          ...
          <button
            onClick={(e) => {
              e.preventDefault()
              openCookieSettings() // ✅ helper centralisé
              // ou: openCookieSettings({ showAlert:true, message:t('cookiesNotReady') })
            }}
            className="hover:text-doré transition-colors duration-200 text-left"
          ...
          {/* Désactive ce bloc si tu n'as pas ajouté les clés i18n contact.* */}
          {/* <a
