...
import HeroB2BSection from '../components/b2b/HeroB2BSection'
import useButtonHover from '@/hooks/useButtonHover'

// Dynamic imports
const CountriesSection = dynamic(() => import('../components/b2b/CountriesSection'), { ssr: false })
const RoleSection = dynamic(() => import('../components/b2b/RoleSection'), { ssr: false })
const DifferentiatorsSection = dynamic(() => import('../components/b2b/DifferentiatorsSection'), { ssr: false })
const ServicesB2BSection = dynamic(() => import('../components/b2b/ServicesB2BSection'), { ssr: false })
const TargetsSection = dynamic(() => import('../components/b2b/TargetsSection'), { ssr: false })
const ContactB2BSection = dynamic(() => import('../components/b2b/ContactB2BSection'), { ssr: false })
